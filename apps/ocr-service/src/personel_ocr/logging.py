...
All log output is newline-delimited JSON; suitable for OpenSearch / Loki
log aggregators.

Usage:
    from personel_ocr.logging import get_logger
    logger = get_logger(__name__)
    logger.info("ocr.extracted", word_count=142, latency_ms=340)
"""
...
# ContextVar so request_id is available inside handlers without threading.local tricks.
