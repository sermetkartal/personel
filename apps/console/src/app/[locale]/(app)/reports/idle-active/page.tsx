...
interface IdleActiveReportPageProps {
...
export default async function IdleActiveReportPage({
  params,
}: IdleActiveReportPageProps): Promise<JSX.Element> {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div className="flex flex-col items-center justify-center rounded-lg border border-dashed py-20 text-center">
        ...
        <p className="text-muted-foreground text-sm">Phase 2 — idle/active area chart</p>
      </div>
    </div>
  );
}
