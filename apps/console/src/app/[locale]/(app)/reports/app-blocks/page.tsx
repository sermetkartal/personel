...
interface AppBlocksReportPageProps {
...
export default async function AppBlocksReportPage({
  params,
}: AppBlocksReportPageProps): Promise<JSX.Element> {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div className="flex flex-col items-center justify-center rounded-lg border border-dashed py-20 text-center">
        ...
        <p className="text-muted-foreground text-sm">Phase 2 — blocked app events table</p>
      </div>
    </div>
  );
}
